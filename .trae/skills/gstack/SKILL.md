...
description: |
  ...
  /review; visual audit /design-review; shipping /ship; docs /document-release;
  project knowledge base /doc-init; retro /retro; second opinion /codex; prod safety
  /careful or /guard; scoped edits /freeze or /unfreeze; gstack upgrades /gstack-upgrade. If the user opts out of suggestions, stop
