...
| `/doc-init` | **Context Engineer** | Initialize or maintain a structured `docs/` knowledge base with architecture docs, freshness tracking, and navigation index. Two modes: init (first-time) and garden (incremental). |
...
/investigate, /document-release, /doc-init, /codex, /cso, /autoplan, /careful, /freeze, /guard,
